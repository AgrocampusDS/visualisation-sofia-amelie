...
fig %>% 
  colorbar(title =list(text=paste0("Différence de \nl'espérance de vie \nà la naissance \nentre 2018 et 2000 \n(en années)"), font=list(size=12)), x = 1, y = 0.87, len = 0.7) %>% 
...
ggplot(data = dta_SYR) +
  ...
  labs(title="Evolution de l'espérance de vie en Syrie", 
...
ggplot(data = dta_off[dta_off$ISO3 == "GRD",], 
  ...
  labs(title='Espérance de vie Grenada', # ajout du titre
       subtitle='De 2000 à 2018')  # ajout du sous titre
```
...
```{r}
# library(patchwork) # to put plots side to side
# 
# # Espérance de vie
# g1 <- ggplot(data = dta_off[dta_off$ISO3 == "VEN",], 
#        aes(x = Year, y = Life.expectancy, group=1)) +
#   
#   geom_line(color = "#00AFBB", size = 2) +
#   
...
#   annotate(geom = "text", 
#            x = 1.8, y = 72.1, 
#            label = "Présidence d'Hugo Chávez", 
#            hjust = "left") +
#   
#   annotate(geom = "rect",
#            xmin = 14, xmax = 19,
...
#   annotate(geom = "text", 
#            x = 12.8, y = 72.1, 
#            label = "Présidence de Nicolás Maduro", 
#            hjust = "left") +
#   
#   theme_classic()
...
# lines <- c("Observed" = "solid", "Predicted" = "dashed")
# 
# g2 <- ggplot(data = GDP_VEN,
#        aes(x = Year, group=1)) +
#   
#   geom_line(aes(y = GDP_obs, linetype = "Observed"), color = "#00AFBB", size = 1.5) +
#   
#   geom_line(aes(y = GDP_pred, linetype = "Predicted"), color = "#00AFBB", size = 1.5) +
#   
...
# 
#   annotate(geom = "text",
#            x = 14.3, y = min(GDP_VEN$GDP)-5e+10,
#            label = "Présidence de \nNicolás Maduro",
#            hjust = "left") +
#   
#   theme_classic()
...
plot_ly(dta_dual_y) %>%
  ...
  add_lines(x = ~Year, y = ~Life.expectancy, yaxis="y1", name="Life expectancy", 
            line = list(color = 'black', width = 2)) %>%
  
  add_lines(x = ~Year, y = ~GDP_obs, yaxis = "y2", name="Observed GDP",
            line = list(color = '#00AFBB', width = 2)) %>%
  
  add_lines(x = ~Year, y = ~GDP_pred, yaxis = "y2", name="Predicted GDP",
